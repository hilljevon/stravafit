...
const ClientDashboardComponent = () => {
    ...
    console.log("My all data here", allData)
    return (
        <div className="chart-wrapper mx-auto flex flex-col flex-wrap items-start justify-center gap-10 sm:flex-row py-2">
            ...
            <div className="grid w-full flex-1 gap-6">
                ...
                >
                    {/* CHART 7 HEADER */}
                    <CardHeader className="p-4 pb-0">
                        <CardTitle>Suffer Score </CardTitle>
                        {allWeeklyData.weeklySufferScore && (
                            <CardDescription>
                                This week, you have a total suffer score of {allWeeklyData.weeklySufferScore}. Good job!
                            </CardDescription>
                        )}
                    </CardHeader>
                    {/* CHART 7 CONTENT */}
                    <CardContent className="flex flex-row items-baseline gap-4 p-4 pt-2">
                        <div className="flex items-baseline gap-2 text-3xl font-bold tabular-nums leading-none">
                            {Math.floor(allWeeklyData.weeklySufferScore / allWeeklyData.weeklyWorkoutTimes.length)}
                            <span className="text-sm font-normal text-muted-foreground">
                                per workout
                            </span>
                        </div>
